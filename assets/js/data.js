const resume = {
  ...
  experience: [
    ...
    },
    {
      ...
      country: "Canada",
      accomplishments: [
        "Build a role-based financial app (React, Node.js, PostgreSQL) to replace manual Excel/email workflows.",
        "Automated claims approval via middleware and RESTful APIs, cutting processing time and reducing errors.",
        "Create diagrams and mockups to support UX and logic design, enhancing feature planning clarity.",
        "Configure Docker-based environments for dev and CI/CD, streamlining setup and deployment.",
        "Facilitated Agile team syncs, sharing updates and proposing improvements to boost delivery efficiency.",
      ],
    },
  ],
  projects: [
